    ...
    public static void main(String[] args) {
        ...
        if (merek.equalsIgnoreCase("specs")) {
            if (kategori.equalsIgnoreCase("slip on")) {
                if (ukuran >= 36) {
                    if (ukuran <= 40) {
                        System.out.println("Harga sepatu anda adalah: Rp. 800.000");
                    } else {
                ...
                if (ukuran >= 40) {
                    if (ukuran <= 44) {
                        System.out.println("Harga sepatu anda adalah: Rp. 1.200.000");
                    } else {
                        System.out.println("Invalid");
                    }
                } else {
            ...
            if (kategori.equalsIgnoreCase("woman")) {
                if (ukuran >= 36) {
                    if (ukuran <= 41) {
                        System.out.println("Harga sepatu anda adalah: Rp. 1.000.000");
                    } else {
                        System.out.println("Invalid");
                    }
                } else {
                ...
                if (ukuran >= 41) {
                    if (ukuran <= 44) {
                        System.out.println("Harga sepatu anda adalah: Rp. 1.800.000");
                    } else {
                        System.out.println("Invalid");
                    }
                } else {
                ...
                if (kategori.equalsIgnoreCase("kids")) {
                    if (ukuran >= 36) {
                        if (ukuran <= 40) {
                            System.out.println("Harga sepatu anda adalah: Rp. 750.000");
                        } else {
                            System.out.println("Invalid");
                        }
                    } else {
                    ...
                    if (ukuran >= 40) {
                        if (ukuran <= 44) {
                            System.out.println("Harga sepatu anda adalah: Rp. 1.500.000");
                        } else {
                            System.out.println("Invalid");
                        }
                    } else {
